...
SECRET_KEY = "django-insecure-6+0gjgy7i00t4&$zyib8viiv)7))is599@70!)!iy$8ti%w8d@"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "django.contrib.messages.context_processors.messages",  # Remove one occurrence of this line
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'resume',      # Name of your MySQL database
